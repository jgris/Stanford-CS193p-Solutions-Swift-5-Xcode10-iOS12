...
class CardView: UIView {
    ...
    var matchState: Game.MatchState = .notSet { didSet { setNeedsDisplay() } }
    ...
    private var fill: Fill          = .empty
    private var color: Color        = .green
    private var numberOfShapes: Int = 1
    ...
    private func displayBackOfCard() {
    ...
    // MARK: - Animation
    func animateApearance(from sourcePoint: CGPoint, delay: TimeInterval) {
        let viewCenter = center
        let viewBounds = bounds
        self.center = sourcePoint
        bounds.size = CGSize(width: 92 * 0.7, height: 92)
        isFaceUp = false
        alpha = 1
        ...
        UIViewPropertyAnimator.runningPropertyAnimator(
            ...
            animations: {
                ...
                self.bounds.size = viewBounds.size
    ...
    private func drawSquiggle(in rect: CGRect) -> UIBezierPath {
        ...
        bottomPart.apply(CGAffineTransform.identity
            .translatedBy(x: frame.width, y: frame.height - 2)
...
extension CardView
{
    ...
    private struct Constant {
        ...
        static let animationDelay: TimeInterval = 0.4
    }
